    ...
    [
        ...
        'groups' => [
            'main' => [
                ...
                'name' => "contact::contact.groups.main",
                'key' => "main",
                'title' => "contact::contact.groups.main",
            ],
            'details' => [
                'icon' => "fe:home",
                'name' => "contact::contact.groups.details",
                'key' => "documents",
                'title' => "contact::contact.groups.details",
            ],
            'images' => [
                'icon' => "fe:home",
                'name' => "contact::contact.groups.images",
                'key' => "documents",
                'title' => "contact::contact.groups.images",
            ],
            'settings' => [
                'icon' => "fe:home",
                'name' => "contact::contact.groups.settings",
                'key' => "documents",
                'title' => "contact::contact.groups.settings",
            ]
        ],
        'controller' => [
            'provider' => 'Litecms',
