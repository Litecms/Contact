...
<div class="app-entry-form-wrap">
        ...
        <div class="actions">
            <div class="action-buttons">
                <button type="button" class="btn btn-with-icon btn-link" data-action='EDIT' data-load-to="#app-entry"
                    data-url="{!!guard_url('contact/contact')!!}/{!!$data['id']!!}/edit"><i
                ...
                <button type="button" class="btn btn-with-icon btn-link" data-action='DELETE' data-load-to="#app-entry"
                    data-list="#item-list" data-url="{!!guard_url('contact/contact')!!}/{!!$data['id']!!}"><i
    ...
    <div class="container-fluid">
        ...
        <div class="col-lg-8 entry-form">
            ...
            ->class('app-form-show')
            ->method('PUT')
            ->action(guard_url('contact/contact'. $data['id']))!!}
            ...
            @include('contact::contact.partials.aside')
        </div>
    </div>
