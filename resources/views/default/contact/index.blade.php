    ...
    <div class="app-list-inner">
        <div class="app-list-header d-flex align-items-center justify-content-between">
            ...
            <button type="button" class="btn add-app-btn btn-icon btn-outline" data-action='CREATE'
                data-load-to="#app-entry" data-url="{{guard_url('contact/contact/create')}}">
            ...
            <div class="app-list-toolbar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="{{guard_url('contact/contact')}}"><i class="las la-inbox"></i>Contacts</a>
                        <a class="dropdown-item" href="{{guard_url('page/page')}}"><i class="las la-inbox"></i>Pages</a>
                        <a class="dropdown-item" href="{{guard_url('block/block')}}"><i class="las la-inbox"></i>Blocks</a>
                    </div>
                </div>
            </div>
            <div class="app-items" data-url="{{guard_url('contact/contact')}}" id="item-list">
                @include('contact::contact.more', ['mode' => 'list'])
            </div>
...
<script type="">
    var module_link = "{{guard_url('contact/contact')}}";
