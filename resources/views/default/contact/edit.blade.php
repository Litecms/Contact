<div class="app-entry-form-wrap">
    <div class="app-sec-title app-sec-title-with-icon app-sec-title-with-action">
        ...
        <div class="actions">
            ...
            <button type="button" class="btn btn-with-icon btn-link  btn-outline" data-action='SHOW'
                data-load-to="#app-entry" data-url="{{guard_url('contact/contact')}}/{!!$contact->getRouteKey()!!}">
    ...
    @include('contact::contact.partial.entry', ['mode' => 'edit'])
